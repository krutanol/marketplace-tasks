...
CREATE TABLE "task_articles" (
    ...
    CONSTRAINT "task_articles_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "task_articles" ADD CONSTRAINT "task_articles_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "task_articles" ADD CONSTRAINT "task_articles_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
